...
function RaitingProfile() {
  ...
  return (
    <div className="w-[532px] h-[207px] p-5 rounded-xl relative bg-white">
      {/* Lớp giả để phủ toàn bộ thẻ div lại, khi ấn vào nút dropdown thì lớp giả này sẽ được hiện lên. */}
      {dropdownBtn && (
        <div
      ...
      {/* div dropdown. Khi chưa ấn thì opacity của nó sẽ là 0, và khi ấn thì cho nó hiện lên. */}
      <div
      ...
      >
        {/* Sử dụng transfromOrigin để tạo hiện ứng animation */}
